...
| ----------- | ------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| README      | The page still referred to the initial `0.1.0` publication and a future screenshot gallery. | Updated it to describe the public `0.1.1` listing, the `0.1.3` GitHub security release, current release assets, and public links.                                                       |
...
| Marketplace | Public Marketplace is `0.1.1`; GitHub `main` is `0.1.3`.                                    | Documentation now clearly separates the published listing from the GitHub security release. A new Marketplace publication is not claimed because the publisher credential was rejected. |
...
- The `0.1.3` Marketplace publication is not claimed; the public listing remains `0.1.1`.
