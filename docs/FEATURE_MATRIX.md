...
| Marketplace publication      | Partial | 0.1.2 listing independently verified; 0.1.3 GitHub release is validated, but the security patch is not Marketplace-published                 |
