...
- Reworked the public README with a public-safe webview screenshot, current Marketplace links, and explicit separation between the `0.1.1` listing and the `0.1.3` GitHub release.
